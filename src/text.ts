...
import type { TextResult } from './@types/TextResult.ts';
import type { TextValidationHint } from './@types/TextValidationHint.ts';
import type { TextPromptState } from './core/@types/TextPromptState.ts';
import type { TextPromptStateChangeReason } from './core/@types/TextPromptStateChangeReason.ts';
import type { TextPromptStateUpdate } from './core/@types/TextPromptStateUpdate.ts';
import type { Man } from './core/man/@types/Man.ts';
import { printMan } from './core/man/printMan.ts';
import { stdin } from './core/stdio/index.ts';
import { withResolvers } from './core/tools/withResolvers.ts';
import { textPrompt } from './core/textPrompt.ts';
import { createWriter } from './core/writer.ts';
import { TEXT_DEFAULT_WIDTH } from './constants.ts';
import { getClipboard } from './clipboard.ts';
import { setClipboard } from './clipboard.ts';
import * as symbol from './symbol.ts';
import { TerminatedByCtrlC } from './TerminatedByCtrlC.ts';
import { TerminatedByEsc } from './TerminatedByEsc.ts';
